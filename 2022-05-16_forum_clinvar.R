# Description: Why did ClinVar annotation disappear between 5 and 6 main GENIE releases.
# Source: https://www.synapse.org/#!Synapse:syn7222066/discussion/threadId=9265
...
# synapse
synid_file_mut5 <- "syn17394041"
synid_file_mut6 <- "syn20333098"
...
df_mut5 <- get_synapse_entity_data_in_csv(synid_file_mut5, sep = "\t")
df_mut6 <- get_synapse_entity_data_in_csv(synid_file_mut6, sep = "\t")

# main ----------------------------

print(setdiff(colnames(df_mut5), colnames(df_mut6)))
print(glue("Number of columns for 5.0-public: {ncol(df_mut5)}"))
print(glue("Number of columns for 6.2-public: {ncol(df_mut6)}"))
